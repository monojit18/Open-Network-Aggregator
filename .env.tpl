...
TRANSLATELIB_HOST="https://onix-dev.gcpwkshpdev.com"
...
AGENTIC_TEXT_EMBEDDING="<AGENTIC_TEXT_EMBEDDING>"
AGENTIC_TEXT_EMBEDDING_DISTANCE="DOT_PRODUCT"
AGENTIC_BQ_DATASET="<AGENTIC_BQ_DATASET>"
AGENTIC_BQ_TABLE="<AGENTIC_BQ_TABLE>"
