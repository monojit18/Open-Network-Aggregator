...
async function performLLMChat(llmInfo)
{
    try
    {
        ...
        fireCallbackEvent(llmResponse, llmInfo);
    }
    catch(exception)
    {
        throw exception;
