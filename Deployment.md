...
> **Note**:
>
> **PROJECT_NAME** - This ideally should be same as *PROJECT_ID*; or any preferred name to identify the proejct.
>
...
>
> All template deployment files for Helm charts will be shared trhough a folder called **values.tpl**; which can be found under:
>
...
>
> All template deployment files for K8s Gateway API will be shared trhough a folder called **k8s-api-gateway.tpl**; which cna be found under:
>
