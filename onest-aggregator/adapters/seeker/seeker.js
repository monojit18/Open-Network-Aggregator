...
const KAdapterRoom = "seeker-adapter-room";
...
function fireCallbackEvent(requestBody, actionString)
{
    ...
    try
    {
        ...
        _socketIOClient.emit(KCallbackEvent, seekerData);
...
async function initSocketServerConnection()
{
    ...
    {
        console.log(`initSocketServerConnection - ${exception.message}`);
        throw exception;
    }
}
...
async function initSocketClient()
{
    ...
    const socketQuery = {}
    socketQuery[KRoomKey] = KAdapterRoom;
...
async function prepareCallbackResponse(request, actionString)
{
    ...
    {       
        ...
        const callbackResponse = fireCallbackEvent(requestBody, actionString);
        return callbackResponse;
    }
    catch(exception)
    {        
