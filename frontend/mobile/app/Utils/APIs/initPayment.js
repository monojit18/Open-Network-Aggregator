...
export const Adapterinit = async () => {
  // API endpoint
  const url = 'https://master-middleware-4encm3loxa-as.a.run.app/init';
  const payload = {
    // context: {
    //   action: 'on_search',
...
export const initPayment = async searchText => {
  ...
  try {
    ...
    const response = await Adapterinit(searchText, messageId);
