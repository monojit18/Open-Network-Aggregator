...
export const AdapterSelect = async (courseId, providerId) => {
  // API endpoint
...
export const selectCourse = async (courseId, providerId) => {
  ...
  try {
    ...
    const response = await AdapterSelect(courseId, providerId);
