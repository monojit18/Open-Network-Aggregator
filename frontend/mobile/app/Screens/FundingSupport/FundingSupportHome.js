...
export default class FundingSupportHome extends Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      data: [{id: 1, name: 'Home'}],
      searchText:
        props.route?.params?.searchText || 'scholarship for undergraduate',
      initialSearchText: 'scholarship for undergraduate',
      inputText: '',
      showInput: false,
      appliedFilters: {},
      filterText: '',
  ...
  filters = [
    ...
    {
      label: 'Social Eligibility',
      checkboxes: [
        {id: 1, label: 'SC', value: 'sc', field: 'Social Eligibility'},
        {id: 2, label: 'ST', value: 'st', field: 'Social Eligibility'},
      ],
    },
    {
